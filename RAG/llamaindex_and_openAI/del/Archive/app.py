...
if st.session_state.logged_in:
    ...
    if st.session_state.query_engine == "Not yet loaded":
        ...
        tid=os.getenv('SAMPLE_THREAD')
        st.session_state.thread_id=tid
        st.sidebar.write("Chat thread id:",tid)
        ...
        if prompt:=st.chat_input("Ask you query here"):
            ...
            run=client.beta.threads.runs.create(
                ...
                instructions="""
                Please address the user as "Vinner" and ask the user if he/she has any queries related to vinculum solutions.
                """
            )
            with st.spinner("Wait... Generating response..."):
